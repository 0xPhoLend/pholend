...
export interface IArgsForReserve {
	aToken: AToken & {
...
export interface IDeployedStrategies {
	[key: string]: DefaultReserveInterestRateStrategy & {
		deploymentTransaction(): ContractTransactionResponse
	}
}

export interface INetworks {
	[key: string]: IReserveAsset[]
}
...
export interface ITestEnv {
	// testEnv: MintableERC20 & { deploymentTransaction(): ContractTransactionResponse }
